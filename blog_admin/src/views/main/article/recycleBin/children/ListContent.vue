<template>
  <div class="content">
    <el-table stripe :data="props.articleList" style="width: 100%">
      ...
      <el-table-column prop="father_category_id" label="文章类别" width="120" align="center">
      ...
      <el-table-column label="状态" min-width="76" align="center">已删除</el-table-column>
      <el-table-column prop="published_time" sortable label="发布日期" min-width="190" align="center" />
      <el-table-column prop="deleted_time" sortable label="删除日期" min-width="190" align="center" />

      <el-table-column fixed="right" label="选项" min-width="155" align="center">
        <template #default="scope">
          <el-button link type="primary" size="small"
            @click="handleClick(scope.row.article_id, form.detail)">详情</el-button>
          <el-button link type="primary" size="small"
            @click="handleClick(scope.row.article_id, form.restore)">恢复</el-button>
